...
<head>
  ...
  <title>Thickness Measurement &mdash; Stisla</title>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            ?>
            <div class="profile_pic" style="background: #000 url('<?=$profile;?>') center center no-repeat;"></div>
            <div class="d-sm-none d-lg-inline-block" style="padding-left: 25px">Hi, {{ auth()->user()->name }}</div></a>
...
<!--               <a href="<?=url('/profile');?>" class="dropdown-item has-icon">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; <?=date('Y');?> <div class="bullet"></div> PT. BIRO KLASIFIKASI INDONESIA
        </div>
