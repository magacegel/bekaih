                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                          <div class="header-profile-user" style="background:#405189 url('<?=Auth::user()->profile_image ? url('storage/uploads/profile_image/').'/'.Auth::user()->profile_image : URL::asset('images/no_profile.png');?>') center center no-repeat;">
                          </div>

                            <!-- <img class="rounded-circle header-profile-user" src="<?=Auth::user()->profile_image ? url('storage/uploads/profile_image/').'/'.Auth::user()->profile_image : URL::asset('images/no_profile.png');?>" alt="Header Avatar"> -->
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?=Auth::user()->name;?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?=ucfirst(Auth::user()->level);?></span>
                            </span>
                        </span>
                    </button>
<!-- http://localhost:8081/images/no_profile.png -->
<!-- /storage/uploads/profile_image/ -->
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        ...
                        <a class="dropdown-item " href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1"></i> <span key="t-logout">Log Out</span></a>
